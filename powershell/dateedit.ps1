...
# Fetch the parameters. If they are not supplied, ask the user to enter them. We
# make sure that Get-Date does not receive extra quotes.

# Keep in mind that the formatting of the DateTime can vary. The date needs to
# be listed but the actual time is optional and can be formatted in different
# ways. Example: 04/20/1999 13:42:32 or 11/27/1996 6PM. Datetime also for some
# reason wants the American date format when constructing from a parameter but
# asks for the user's system date format when it receives the date via Get-Date.
